(def matrix-profiles
  '{:matrix-clj-1.8 {:dependencies [[org.clojure/clojure "1.8.0"]]}
    ...
    :matrix-clj-1.11 {:dependencies [[org.clojure/clojure "1.11.1"]]}
    :matrix-clj-1.12 {:dependencies [[org.clojure/clojure "1.12.0-master-SNAPSHOT"]]
                      :repositories [["sonatype-oss-public" {:url "https://oss.sonatype.org/content/groups/public"}]]}
    :matrix-cljs-1.10.879 {:dependencies [[org.clojure/clojure "1.11.1"]
                                          [org.clojure/clojurescript "1.10.879"]]}
    :matrix-cljs-1.10.891 {:dependencies [[org.clojure/clojure "1.11.1"]
...
(defproject com.ambrosebs/instrument-defprotocol "1.0.0-SNAPSHOT"
  ...
  :plugins [[lein-codox "0.10.7"]
            [lein-shell "0.5.0"]
            [lein-pprint "1.3.2"]]
  :repl-options {:init-ns com.ambrosebs.instrument-defprotocol.clj})
